...
import UserAccountPage from '../pages/account/UserAccount';
...
// All routes
const authProtectedRoutes = [rootRoute, dashboardRoutes, ...appRoutes, pageRoutes, uiRoutes, userRoute, serviceRoute];
